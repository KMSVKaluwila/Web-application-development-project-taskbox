...
if ($num > 0) {
    ...
    $mail->Password = 'cbgjrzxhafaabqng';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to

    $mail->setFrom('sachinvimukthikaluvila@gmail.com', 'TaskBox');
        ...
        <tr>
            <td align="center">
                <table style="max-width: 600px; margin-top: 2%;">
                    <tr>
                        <td align="center">
                            <a href="" style="font-size: 35px; font-weight: bold; color: black; text-decoration: none;">TaskBox</a>
                            <hr>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <div>
                                <a href="http://localhost/TaskBox/resetPassword.php?vcode='.$vcode.'" style="text-decoration: none; display: inline-block; border-radius: 5px; background-color: blue;
                    ...
                    <tr>
                        <td align="center">
                            <p style="font-weight: bold;">&copy; 2024 TaskBox.lk || All right reserved</p>
                        </td>
                    </tr>
