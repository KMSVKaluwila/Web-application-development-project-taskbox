    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                $rs = Database::search("SELECT * FROM `order_hitory` WHERE order_hitory.`user_userID` = '" . $user["userID"] . "'");
                $num = $rs->num_rows;
                            ...
                            <div class="px-5">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $rs2 = Database::search("SELECT * FROM `order_iteam`
                                        INNER JOIN `stock` ON order_iteam.`stock_stock_ID` = stock.`stock_ID`
                                        INNER JOIN `product` ON stock.`product_pro_ID` = product.`pro_ID` WHERE order_iteam.`order_hitory_ohid` = '" . $d["ohid"] . "'");
                                        ...
                                        ?>
                                            <tr>
                                                <td scope="row"><?php echo ($d2["pro_name"]) ?></td>
